...
/**
 * Pure pacing rules for the shared outgoing-chat gatekeeper. Tuned conservatively for Hypixel:
 * replaces SweatReport's old independent ~0.5s cadence with a single global gap, and keeps a
 * quiet window after player-written chat before optional automation may resume.
 *
...
public final class OutgoingChatPolicy {
    ...
    public static boolean canSend(OutgoingChatKind kind, long nowMs, long lastSendMs, long lastManualMs,
        ...
        if (nowMs - lastSendMs < MIN_GAP_MS) return false;
